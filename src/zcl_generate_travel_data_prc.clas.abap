CLASS zcl_generate_travel_data_prc DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_prc IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_app_prc.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_app_prc.

*   insert the new table entries
    INSERT ztravel_app_prc FROM TABLE @itab.
